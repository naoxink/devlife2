...
a.notification.parentNode&&(a.notification.parentNode.removeChild(a.notification),a.notification=null);"function"===typeof a.config.callback&&a.config.callback.call(a)},500)};a.getConfigCopy=function(){return Object.assign({id:a.newNotifID()},a.config)};a.dismiss=function(){a.destroy()};a.init()}(d)};export default notif